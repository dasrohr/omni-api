...
// === /task ===
// GETs
taskRouter.get('/', task.getTaskStatus );                //a
taskRouter.get('/queue/active', task.getActiveTasks );   //a
taskRouter.get('/queue/waiting', task.getQueuedTasks );  //a
taskRouter.get('/queue/all', task.getAllTasks );         //a
// POSTs
taskRouter.post('/:task', task.callTask );               //a
