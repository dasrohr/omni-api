const express    = require( 'express' )                     // import express
    ...
    , app        = express()                                // load express

// import middleware functions
    , dbQuery    = require( './middleware/db_queries' )     // load database queries
    , task       = require( './middleware/celery_tasks' )   // load celery tasks
    , status     = require( './middleware/status' )         // load status functions
    , fs         = require( './middleware/fs' )             // load file system functions
...
// === /fs ===
// GETs
fsRouter.get( '/alb', fs.getAlbum );
fsRouter.get( '/art', fs.getArtist );
